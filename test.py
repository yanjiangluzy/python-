...
# # # import tkinter
# # # # tkinter库的简要测试
# # # # https://zhuanlan.zhihu.com/p/75872830  -- 入门教程
# # #
# # # # 两种布局：grid和place， 第一种以二维数组的形式布局，第二种更加自由，由人指定xy坐标
# # #
# # # # from tkinter import *
# # # #
# # # # window = tkinter.Tk()
# # # # window.title("test")
# # # # lbl1 = Label(window, text="hello world", font=("Arial Bold", 50))  # Label标签组件，可以用来添加文本
# # #
# # #
# # # # lbl1.grid(column=0, row=0)
# # # # lbl2 = Label(window, text="hello world", font=("Arial Bold", 50))
# # # # lbl2.grid(column=0, row=1)  # column是列，row是行, 相当于二维数组
# # # #
# # # #
# # # # def handler():
# # # #     print("get a event!!!")
# # # #     default_txt.set("button was be click!")
# # # #
# # # #
# # # # #
# # # #
# # # #
# # # # default_txt = tkinter.StringVar()
# # # # default_txt.set("test")
# # # # ent = Entry(window, width=10, font=("Arial Bold", 50), textvariable=default_txt)
# # # # ent.grid(column=0, row=0)
# # # # btn = Button(window, text="click me", command=handler)  # button组件，用来添加按钮, bg和fg分别用来设置背景色和字体颜色，command用来设置点击按钮的处理函数
...
# # # # sock.connect(("127.0.0.1", 7680))
# # # # print(sock.getsockname())  # getsockname会打印出当前进程的端口号和ip
# # # # sock.close()
# # #
# # #
import tkinter
...
txt.set("test")
message_box = scrolledtext.ScrolledText(window, width=300, height=150)
message_box.place(x=0, y=0)
message_box.insert(tkinter.END, "hello\n")
...
btn = tkinter.Button(window, text="add word", width=50, height=50, command=handler)
btn.place(x=0, y=160)
window.mainloop()
...
# message_box.insert(tkinter.END, "欢迎", 'green')
